...
- [Добро пожаловать](01_intro/00_welcome.md)
  - [Syntax](01_intro/01_syntax.md)

- [Простой калькулятор](02_basic_calculator/00_intro.md)
  - [Integers](02_basic_calculator/01_integers.md)
  - [Переменные](02_basic_calculator/02_variables.md)
  - [Ветвление: `if`/`else`](02_basic_calculator/03_if_else.md)
  - [Panics](02_basic_calculator/04_panics.md)
  - [Факториал](02_basic_calculator/05_factorial.md)
  - [Циклы: `while`](02_basic_calculator/06_while.md)
  - [Циклы: `for`](02_basic_calculator/07_for.md)
  - [Overflow и underflow](02_basic_calculator/08_overflow.md)
  - [Saturating arithmetic](02_basic_calculator/09_saturating.md)
  - [Преобразования: `as` casting](02_basic_calculator/10_as_casting.md)

- [Ticket v1](03_ticket_v1/00_intro.md)
  - [Structs](03_ticket_v1/01_struct.md)
  - [Валидация](03_ticket_v1/02_validation.md)
  ...
  - [References в памяти](03_ticket_v1/10_references_in_memory.md)
  - [Destructors](03_ticket_v1/11_destructor.md)
  - [Итоги](03_ticket_v1/12_outro.md)
...
- [Traits](04_traits/00_intro.md)
  ...
  - [Associated types и generic types](04_traits/10_assoc_vs_generic.md)
  - [`Clone` trait](04_traits/11_clone.md)
  - [`Copy` trait](04_traits/12_copy.md)
  - [`Drop` trait](04_traits/13_drop.md)
  - [Итоги](04_traits/14_outro.md)

- [Ticket v2](05_ticket_v2/00_intro.md)
  - [Enums](05_ticket_v2/01_enum.md)
  - [Ветвление: `match`](05_ticket_v2/02_match.md)
  - [Variants с данными](05_ticket_v2/03_variants_with_data.md)
  - [Ветвление: `if let` и `let/else`](05_ticket_v2/04_if_let.md)
...
- [Ticket Management](06_ticket_management/00_intro.md)
  ...
  - [Изменение размера](06_ticket_management/03_resizing.md)
  ...
  - [Два состояния](06_ticket_management/12_two_states.md)
...
- [Threads](07_threads/00_intro.md)
  ...
  - [Утечка памяти](07_threads/03_leak.md)
